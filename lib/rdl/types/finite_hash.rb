...
module RDL::Type
  ...
  class FiniteHashType < Type
    ...
    def check_bounds(no_promote=false)
      ...
      return (@lbounds.all? { |lbound| RDL::Type::Type.leq(lbound, self, PathTrue.new, no_promote) }) && (@ubounds.all? { |ubound| RDL::Type::Type.leq(self, ubound, PathTrue.new, no_promote) })
    end

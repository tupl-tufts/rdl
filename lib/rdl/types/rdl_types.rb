...
RDL.type 'RDL::Type::NominalType', :name, "() -> String", wrap: false
...
RDL.type 'RDL::Type::FiniteHashType', :elts=, "(Hash<%any, RDL::Type::Type>) -> Hash<%any, RDL::Type::Type>", wrap: false
...
RDL.type 'RDL::Type::OptionalType', :initialize, "(RDL::Type::Type) -> self", wrap: false
...
RDL.type "RDL::Type::Type", 'self.leq', "(RDL::Type::Type, RDL::Type::Type) -> %bool", wrap: false
...
RDL.type "Object", '__getobj__', "() -> self", wrap: false ## needed due to type casting

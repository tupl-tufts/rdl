...
RDL.type :'ActionController::Instrumentation', :redirect_to, '(%any, ?%any) -> ``DBType.redirect_to_output(targs)``', suspend_comp: true, fallback_output: RDL::Globals.types[:json_fallback]

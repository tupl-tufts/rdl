...
type :Kernel, 'self.Integer', '(Numeric or String arg, ?Fixnum base) -> Integer'
# type :Kernel, 'self.Integer', '(arg : [to_int : () -> Integer], base : ?Fixnum) -> Integer'
# type :Kernel, 'self.Integer', '(arg : [to_i : () -> Integer], base : ?Fixnum) -> Integer'
...
type :Kernel, 'self.caller', '(?Fixnum start, ?Fixnum length) -> Array<String> or nil'
type :Kernel, 'self.caller', '(Range) -> Array<String> or nil'
type :Kernel, 'self.caller_locations', '(?Fixnum start, ?Fixnum length) -> Array<String> or nil'
type :Kernel, 'self.caller_locations', '(Range) -> Array<String> or nil'
# type :Kernel, 'self.catch' # TODO
type :Kernel, 'self.eval', '(String, ?Binding, ?String filename, ?Fixnum lineno) -> %any'
# type :Kernel, 'self.exec' #TODO
type :Kernel, 'self.exit', '(Fixnum or %bool status) -> %bot'
type :Kernel, 'self.exit!', '(Fixnum or %bool status) -> %bot'
...
type :Kernel, 'self.gets', '(?String, ?Fixnum) -> String'
...
type :Kernel, 'self.open', '(String path, ?(String or Fixnum) mode, ?String perm) -> IO or nil'
# type :Kernel, 'self.open', '(String path, mode : ?String, perm: ?String) {(IO) -> %any)} -> %any' # TODO: returns block value
# type :Kernel, 'self.open', '(String path, mode : ?Fixnum, perm: ?String) {(IO) -> %any)} -> %any' # TODO: returns block value
...
type :Kernel, 'self.putc', '(Fixnum) -> Fixnum'
...
type :Kernel, 'self.rand', '(Fixnum or Range max) -> Numeric'
type :Kernel, 'self.readline', '(?String, ?Fixnum) -> String'
type :Kernel, 'self.readlines', '(?String, ?Fixnum) -> Array<String>'
...
type :Kernel, 'self.sleep', '(Numeric duration) -> Fixnum'
...
type :Kernel, 'self.syscall', '(Fixnum num, *%any args) -> %any' # TODO : ?

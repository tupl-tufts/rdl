...
RDL.type :Hash, :fetch, '(``any_or_k(trec)``) { (``RDL::Type::OptionalType.new(any_or_k(trec))``) -> u } -> ``RDL::Type::UnionType.new(RDL::Globals.parser.scan_str("#T u"), output_type(trec, targs, :fetch, :promoted_val, "v", nil_default: true))``'

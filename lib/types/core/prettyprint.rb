RDL.type :PrettyPrint, 'self.format', '(?String output, ?Integer maxwidth, ?String newline) { (PrettyPrint) -> String } -> PrettyPrint'
...
RDL.type :PrettyPrint, :text, '(String obj, ?Integer width) -> %bot'

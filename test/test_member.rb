...
class TestMember < Minitest::Test
  ...
  def test_finite_hash
    ...
    t3 = FiniteHashType.new({"a"=>RDL.types[:symbol], 2=>RDL.types[:string]}, RDL.types[:integer])
    ...
    t4 = FiniteHashType.new({a: RDL.types[:symbol], b: RDL.types[:string]}, RDL.types[:integer])
    ...
    t5 = FiniteHashType.new({a: RDL.types[:symbol], b: OptionalType.new(RDL.types[:string])}, RDL.types[:integer])

class File
  ...
  type 'self.open', '(String or Pathname "file", ?String "file", ?String "perm", ?Fixnum "opt") -> File'
  type 'self.open', '(String or Pathname "file", ?String "mode", ?String "perm", ?Fixnum "opt") { (File) -> t } -> t'

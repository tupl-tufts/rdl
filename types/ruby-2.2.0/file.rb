class File
  ...
  type 'self.atime', '(String or IO "file") -> Time'
  type 'self.basename', '(String "file", ?String "suffix") -> String "base_name"'
  type 'self.birthtime', '(String or IO "file") -> Time'
  ...
  type 'self.ctime', '(String or IO "file") -> Time'
  ...
  type 'self.exist?', '(String or IO or Pathname "file") -> %bool'
  # exists? deprecated
  type 'self.expand_path', '(String or Pathname "file", ?(String or Pathname) "dir") -> String "abs_file"'
  ...
  type 'self.mtime', '(String or IO "file") -> Time'
  type 'self.new', '(String "file", ?String "mode", ?String "perm", ?Fixnum "opt") -> File'
  type 'self.open', '(String or Pathname "file", ?String "file", ?String "perm", ?Fixnum "opt", mode:?String, external_encoding: ?String, internal_encoding: ?String, encoding: ?String, textmode: ?%any, binmode: ?%any, autoclose: ?%any) -> File'
  type 'self.open', '(String or Pathname "file", ?String "mode", ?String "perm", ?Fixnum "opt", mode:?String, external_encoding: ?String, internal_encoding: ?String, encoding: ?String, textmode: ?%any, binmode: ?%any, autoclose: ?%any) { (File) -> t } -> t'
  ...
  type 'self.stat', '(String "file") -> File::Stat'
